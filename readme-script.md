...
После запуска отработает скрипт настроек для расширения корневой файловой системы OpenWRT на отдельный раздел диска. Цель скрипта перенести корневую файловую систему OpenWRT с ограниченной внутренней памяти на внешний накопитель для увеличения доступного пространства.
