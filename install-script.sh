...
cd /tmp && wget https://raw.githubusercontent.com/arhitru/TP-Link-Arcer-C5-USB/main/setup_required.sh -O setup_required.sh && chmod +x setup_required.sh && ./setup_required.sh
